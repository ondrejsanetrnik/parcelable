...
class Gls
{
    public const STATUS_MAP = [
        ...
        'P&S/P&R - žádný balík k vyzvednutí' => 'Čeká na vyzvednutí kurýrem',
        ...
        'Přesměrováno na depo'             => 'V přepravě',
        'HUB Inbound'                      => 'V přepravě',
        'HUB Outbound'                     => 'V přepravě',
        'HUB Storage'                      => 'V přepravě',
        'Příchod na třídicí centrum'       => 'V přepravě',
        'Odesláno z třídicího centra'      => 'V přepravě',
        'Nesprávné PSČ'                    => 'V přepravě',
        'Nesprávné nasměrování na depo'    => 'V přepravě',
        'Chybně směrováno'                 => 'V přepravě',
        ...
        'Damaged'                          => 'V přepravě',
        'Poškozeno'                        => 'V přepravě',
        'Nesprávná adresa'                 => 'V přepravě',
        'Nesprávná adresa (neúplná)'       => 'V přepravě',
        'Nesprávná trasa'                  => 'V přepravě',
        'Balík bez aktuálního pohybu'      => 'V přepravě',
